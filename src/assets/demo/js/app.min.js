...
! function(r) { "use strict"; "function" == typeof define && define.amd ? define("parollerjs", ["jquery"], r) : "object" == typeof module && "object" == typeof module.exports ? module.exports = r(require("jquery")) : r(jQuery) }(function(g) {
    "use strict";
    var v = !1,
        x = function() { v = !1 },
        b = function(r, t) { return r.css({ "background-position": "center " + -t + "px" }) },
        k = function(r, t) { return r.css({ "background-position": -t + "px center" }) },
        y = function(r, t, o, n) { return "none" !== n || (n = ""), r.css({ "-webkit-transform": "translateY(" + t + "px)" + n, "-moz-transform": "translateY(" + t + "px)" + n, transform: "translate(0," + t + "px)" + n, transition: o, "will-change": "transform" }) },
        z = function(r, t, o, n) { return "none" !== n || (n = ""), r.css({ "-webkit-transform": "translateX(" + t + "px)" + n, "-moz-transform": "translateX(" + t + "px)" + n, transform: "translate(" + t + "px, 0)" + n, transition: o, "will-change": "transform" }) },
        M = function(r, t, o) {
        ...
        j = function(r, t) { return Math.round(r * t) },
        X = function(r, t, o, n) { return Math.round((r - o / 2 + n) * t) },
        q = function(r) { return r.css({ "background-position": "unset" }) },
        T = function(r) { return r.css({ transform: "unset", transition: "unset" }) };
    g.fn.paroller = function(h) {
        var m = g(window).height(),
            w = g(document).height();
        h = g.extend({ factor: 0, factorXs: 0, factorSm: 0, factorMd: 0, factorLg: 0, factorXl: 0, transition: "transform .1s ease", type: "background", direction: "vertical" }, h);
        return this.each(function() {
            var o = g(this),
                n = g(window).width(),
                a = o.offset().top,
...
$(document).on("click", ".panel-heading[arie-status='prod']", function() {
...
$(document).on("click", ".panel-heading.tabs[arie-status='prod']", function() {
    ...
    var openOrClose = $("a.panel-heading.tabs[data-serial=" + serial + "][data-num=" + num + "]").attr("aria-expanded");
    //console.log($("a.panel-heading.tabs[data-serial=" + serial + "][data-num=" + num + "]").attr("aria-expanded"));
...
$(document).on("click", ".card", function () {
 ...
 $(".radioLable").removeAttr("disabled"); $(".CancelDisplayNone").remove();$(".CancelDisplayNone2").removeClass("CancelDisplayNone2"); ;  $("[contenteditable=true]").attr("contenteditable", "false");